    ...
    <section className="relative py-24 md:py-32 bg-[#FAF8F5] overflow-hidden">
      ...
      <div className="w-full relative">
        ...
        <div className="flex flex-col gap-6 py-4 relative">
          ...
          <div className="absolute top-0 bottom-0 left-0 w-16 md:w-32 bg-gradient-to-r from-[#FAF8F5] to-transparent pointer-events-none z-10" />
          <div className="absolute top-0 bottom-0 right-0 w-16 md:w-32 bg-gradient-to-l from-[#FAF8F5] to-transparent pointer-events-none z-10" />
